...
import { Avatar, Box, Center, Text, Image, Button, Flex, useColorModeValue } from "@chakra-ui/react";
...
function UserPage({ user }) {
    return (
        ...
        <Box>
            ...
            <Box maxWidth="container.xl" margin="auto" padding="8" backgroundColor={useColorModeValue('white', 'gray.700')}>
